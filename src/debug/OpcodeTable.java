...
// supported by all Cmos 80C85 and SOME Nmos 8085 chips

{"arhl",null,null,"1","10","7"},
{"dsub",null,null,"1","08","10"},
{"jnui","xxxx",null,"3","dd","7"},
{"jui","xxxx",null,"3","fd","7"},
{"ldhi","xx",null,"2","28","10"},
{"ldsi","xx",null,"2","38","10"},
{"lhlx","xx",null,"2","ed","10"},
{"rdel",null,null,"1","18","10"},
{"rstv",null,null,"1","cb","6"},
{"shlx",null,null,"1","d9","10"},
    ...
    public String getOp1(String h)
    {
        for(int i=0;i<table.length;i++)
        {
            if(elementAt(i,HEX).equals(h)) return elementAt(i,OP1);
        }
        return null;
    }
    public String getOp2(String h)
    {
        for(int i=0;i<table.length;i++)
        {
            if(elementAt(i,HEX).equals(h)) return elementAt(i,OP2);
        }
        return null;
    }
}